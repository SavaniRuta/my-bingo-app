    ...
    return (
        <AuthCard>
            ...
            <AuthCardContent className="flex flex-col gap-3">
                ...
                <AuthInput id="password" type="password" required placeholder="john@example.com"/>

                <Button className="w-full text-base bg-link" onClick={() => router.push("/login/verify")}>
                    Sign in
                </Button>
            ...
            <AuthCardFooter className="justify-center">
                <div className="text-muted-foreground text-sm">
                    ...
                    <Link href="/register" className="text-xs text-link underline underline-offset-auto">Sign up</Link>
                </div>
            </AuthCardFooter>
        </AuthCard>
    )
